...
pub struct OidcConfig {
    ...
    pub(crate) sid: Option<String>, // Note: Moved here, as it would otherwise need to be defined in both OpenIDConnectFrontChannelLogoutDiscoveryClaims and OpenIDConnectBackChannelLogoutDiscoveryClaims
...
pub struct OidcDiscoverySessionDiscoveryClaims {
    ...
    pub(crate) check_session_iframe: Option<String>, // Note: Required, but we do not now if the extension is even used...
}
